...
(function(){
  ...
  function wire(root){
    ...
    function autoTick(){
      ...
      if(FOODS.length){ st.food=(st.food+1)%FOODS.length; paintFood(false); }
      if(insight.length){ st.ins=(st.ins+1)%insight.length; paintIns(false); }
    }
