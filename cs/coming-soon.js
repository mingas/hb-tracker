/* coming_soon_v1 — self-contained placeholder for testosteroneblueprintguide.com
   Renders a clean full-screen "coming soon" overlay on 3 noindex placeholder pages,
   keyed by pathname. Adds <meta name="robots" content="noindex,follow">.
...
(function () {
  ...
  var css = '' +
    '#cs-root{position:fixed;inset:0;z-index:2147483600;display:flex;flex-direction:column;' +
    'align-items:center;justify-content:center;text-align:center;background:#0F1A2E;color:#F4ECDD;' +
    'padding:72px 24px;box-sizing:border-box;overflow:auto}' +
